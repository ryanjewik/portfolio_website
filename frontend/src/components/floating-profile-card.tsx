    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className={cn(
            "sticky top-40 ml-[-10px] mr-4 mt-32 w-[28rem] bg-white/95 dark:bg-gray-900/95 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/20 dark:border-gray-700/20 px-8 py-6 pb-0",
            className
          )}
          style={{ 
        ...
        >
          ...
          <div className="text-center mb-6">
            <div className="w-72 h-[28rem] rounded-3xl mx-auto mb-4 overflow-hidden border-4 border-gray-200 dark:border-gray-700 shadow-2xl">
              <img 
            ...
            <p 
              className="text-lg text-gray-600 dark:text-gray-300 mb-2 font-medium"
              style={{ color: isDarkMode ? '#d1d5db' : '#4b5563' }} // Force text color
            >
              {japaneseToggle ? 'フルスタックAI開発者' : title}
            </p>
            <p 
              className="text-base text-gray-500 dark:text-gray-400 flex items-center justify-center"
          ...
          <div className="space-y-3 mb-4">
            <h4 
              className="text-base font-semibold text-gray-700 dark:text-gray-300 mb-3 text-center"
          ...
          <div className="space-y-3 mb-6">
            <a
              ...
              className="block w-full text-white font-medium py-3 px-6 rounded-xl hover:shadow-lg hover:scale-[1.02] transition-all duration-200 text-center flex items-center justify-center gap-2 text-base"
              style={{ 
